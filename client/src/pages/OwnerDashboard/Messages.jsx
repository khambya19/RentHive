        ...
        <div className="p-4 border-b bg-gradient-to-r from-purple-50 to-blue-50">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-4 pr-10 py-2.5 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white text-gray-700"
            />
        ...
        <div className="flex-1 overflow-y-auto">
          {filteredConversations.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-gray-500 p-6">
              ...
              <p className="text-sm text-center mt-2">Messages will appear here when users contact you</p>
            </div>
          ) : (
            filteredConversations.map((conv) => (
              <div
                ...
                className={`p-4 border-b cursor-pointer hover:bg-purple-50 transition ${
                  selectedConversation?.conversationId === conv.conversationId ? 'bg-purple-100' : ''
                }`}
              >
        ...
        {selectedConversation ? (
          <>
            ...
            {(selectedConversation.property || selectedConversation.bike) && (
              <div className="mx-4 mt-4 p-3 bg-white border border-purple-200 rounded-lg shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0">
            ...
            <form onSubmit={sendMessage} className="p-4 border-t bg-white">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg hover:from-purple-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center gap-2"
                >
                  <Send size={18} />
                  Send
                </button>
