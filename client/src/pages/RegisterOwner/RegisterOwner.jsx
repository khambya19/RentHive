...
const RegisterOwner = () => {
  ...
  return (
    <>
      <div className="register-owner-container" style={{ display: 'flex', flexDirection: 'row', width: '100%' }}>
        <div className="register-lessor-card">
        ...
        <div style={{ flex: '1 1 62%', minWidth: '400px', padding: '36px', maxHeight: '90vh', overflowY: 'auto' }}>
          <h2 style={{ fontSize: 28, textAlign: 'center', margin: 0, marginBottom: 24, color: '#333' }}>Sign up as Owner</h2>
